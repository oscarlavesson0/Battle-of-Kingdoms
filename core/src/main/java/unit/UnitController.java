...
public class UnitController {
    ...
    public int[] cancelMove(Unit unit) {
        ...
        // Rensa nuvarande position
        tileGrid[unit.getY()][unit.getX()].setUnit(null);

        // Återställ tile-referensen på ursprungsrutan
